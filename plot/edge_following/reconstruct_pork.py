...
# ---------- 读取位移 ----------
file_path = os.path.join('E:/module2/txt/rl_yxw', 'xy_pork.txt')
displacements = []
...
# 方向箭头
ax.annotate('', xy=(-10, -30), xytext=(-10, 0),
...
ax.set_xticks(np.arange(-40, 130, 20))
ax.set_yticks(np.arange(-120, 50, 20))
ax.tick_params(axis='both', labelsize=35)
ax.legend(loc='upper right', fontsize=25, frameon=True)

# ---------- 0. 把透明 PNG 插到最底层 ----------
img_path = r'E:\module2\img\img_result\soft\pork_bg.jpg'  # ← 你的透明背景图
arr = mpimg.imread(img_path)                          # 0-1 浮点 RGBA


# 控制图在轴系里的“左下角”位置、缩放系数
x0, y0, zoom = 37, -45, 0.18      # ← 自己调，单位 mm
