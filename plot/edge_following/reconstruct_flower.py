...
# ---------- 读取位移 ----------
file_path = os.path.join('E:/module2/txt/rl_yxw', 'xy_flower.txt')
displacements = []
...
# ---------- 0. 把透明 PNG 插到最底层 ----------
img_path = r'E:\module2\img\img_result\soft\flower_bg.jpg'  # ← 你的透明背景图
arr = mpimg.imread(img_path)                          # 0-1 浮点 RGBA


# 控制图在轴系里的“左下角”位置、缩放系数
x0, y0, zoom = 35, 0, 0.155      # ← 自己调，单位 mm
