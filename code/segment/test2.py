...
def test(net, device, test_data_dir, output_dir, scale_factor=0.5):
    ...
    for filename in test_files:
        if filename.endswith(('.png', '.jpg', '.jpeg')):
            ...
            mask = 1 - mask  # 反转掩码，将背景和前景交换11111111111111111111111111111111111111111111111111111111111111111111
            ...
            result.save(os.path.join(output_dir, f'{os.path.splitext(filename)[0]}.png'))
            # 加载真值语义分割图
...
if __name__ == '__main__':
    ...
    #model_path = './checkpoints/checkpoint_epoch_segnet.pth'
    # model_path = './checkpoints/checkpoint_epoch_deeplabv3plus.pth'
    # test_data_imgs = './test_img/imgs/'
    # test_data_masks = './test_img/masks/'
    # output_dir = './test_results/'

    test_data_imgs = './crop1/'
    #test_data_imgs = './crop_180/'
    # test_data_imgs = './data/imgs/'
    ...
    # 执行测试
    test(net, device, test_data_imgs, output_dir, scale_factor=0.5)