...
train_input_folder = '/media/disk1/wl/pix2pix-master/Data/facades/trainB'
train_target_folder = '/media/disk1/wl/pix2pix-master/Data/facades/trainA'
...
#多GPU
torch.save(G.module.state_dict(), model_dir + 'generator_param200.pth')
torch.save(D.module.state_dict(), model_dir + 'discriminator_param200.pth')
