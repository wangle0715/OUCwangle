...
if __name__ == '__main__':
    model = YOLO(r'/media/disk1/wl/yolov11-main/ultralytics/cfg/models/11/yolo11.yaml')

    model.load(r'/media/disk1/wl/yolov11-main/yolo11n.pt') # 是否加载预训练权重,科研不建议大家加载否则很难提升精度
...
#注意conda环境不要使用gjy，而是切换到pytorchffc
