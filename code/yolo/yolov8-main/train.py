...
if __name__ == '__main__':
    model = YOLO(r'/media/disk1/wl/yolov8-main/ultralytics/cfg/models/v8/yolov8n.yaml')

    model.load(r'/media/disk1/wl/yolov8-main/yolov8n.pt') # 是否加载预训练权重,科研不建议大家加载否则很难提升精度
    ...
    model.train(
                ...
                project=r'/media/disk1/wl/yolov8-main/runs/train',
                name='exp1',#训练实验的名称，输出文件将保存在project/name目录下。
