...
if __name__ == '__main__':
    model = YOLOv10(r'/media/disk1/wl/yolov10-main/ultralytics/cfg/models/v10/yolov10n.yaml')

    model.load(r'/media/disk1/wl/yolov10-main/weights/yolov10n.pt') # 是否加载预训练权重,科研不建议大家加载否则很难提升精度

    model.train(
                data=r'/media/disk1/wl/yolov10-main/data/true.yaml',  #  将data后面替换你自己的数据集地址
                # data=r'/media/disk1/wl/yolov10-main/data/tactile.yaml', 
