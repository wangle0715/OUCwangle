...
def parse_opt(known=False):
    ...
    #parser.add_argument('--weights', type=str, default=ROOT / 'yolov9t.pt', help='initial weights path')
    parser.add_argument('--weights', type=str, default=' ', help='initial weights path')
    parser.add_argument('--cfg', type=str, default=ROOT / 'detect/yolov9-t.yaml', help='model.yaml path')
    #parser.add_argument('--data', type=str, default=ROOT / 'data/tactile.yaml', help='dataset.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/true.yaml', help='dataset.yaml path')

    # parser.add_argument('--weights', type=str, default='', help='initial weights path')
    # parser.add_argument('--cfg', type=str, default=r'C:\Users\23142\Desktop\yolov9-main\models\detect\yolov9-c.yaml', help='model.yaml path')
    # parser.add_argument('--data', type=str, default='data/VisDrone2019.yaml', help='dataset.yaml path')
